import { IAfterSave, IAfterUpdate, IBeforeSave, IBeforeUpdate, IBeforeValidate, IValidate, SortItem, QueryOptions, ModelAbstract, IBeforeFind, IAfterFind, IBeforeRemove, IAfterRemove } from "../../index";
export declare class Dummy extends ModelAbstract implements IValidate, IBeforeUpdate, IAfterUpdate, IAfterSave, IBeforeSave, IBeforeValidate, IBeforeFind, IAfterFind, IBeforeRemove, IAfterRemove {
    static RECORDS: any[];
    id: any;
    name: any;
    lastUpdated: any;
    ...
    updated: boolean;
    isUpdate: boolean;
    static dummyMockGenerator: () => Dummy;
    ...
    static filterByQuery(query: any, limit?: number, sort?: SortItem, not?: boolean): any;
