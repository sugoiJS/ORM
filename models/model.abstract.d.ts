...
export declare abstract class ModelAbstract implements IModel {
    ...
    sugBeforeFind(): Promise<void>;
    sugAfterFind<T = any>(resolvedData: T): Promise<void | T>;
    ...
    sugAfterUpdate<T = any>(updatedData: T): Promise<void>;
    ...
    sugBeforeRemove(): Promise<void>;
    sugAfterRemove<T = any>(data: T): Promise<void>;
    /**
