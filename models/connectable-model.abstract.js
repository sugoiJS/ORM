...
var ConnectableModel = /** @class */ (function (_super) {
    ...
    ConnectableModel.setConnectionName = function (connectionName) {
        if (connectionName === void 0) { connectionName = "default"; }
        this.connectionName = connectionName;
    };
    ConnectableModel.getConnectionName = function () {
        return this.connectionName;
    };
    ConnectableModel.connect = function (connectionName) {
        if (connectionName === void 0) { connectionName = this.getConnectionName(); }
        var connection = this.connections.get(connectionName);
        if (!connection) {
