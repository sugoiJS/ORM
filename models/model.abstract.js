...
var ModelAbstract = /** @class */ (function () {
    ...
    ;
    ModelAbstract.prototype.sugAfterSave = function () {
        return 'afterSave' in this
            ? this.afterSave() || Promise.resolve()
            : Promise.resolve();
    };
    ;
    ...
    ;
    ModelAbstract.prototype.sugAfterUpdate = function () {
        return 'afterUpdate' in this
            ? this.afterUpdate() || Promise.resolve()
            : Promise.resolve();
    };
    ;
