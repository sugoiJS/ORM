...
class Storeable {
    ...
    removeIgnoredFields() {
        ...
        this.constructor.setModelMeta(Storeable.IGNORED_FIELDS_OBJECT_KEY + "_" + key, metaObject);
        return key;
    }
    revertIgnoredFields(key, value) {
        const metaObject = this.constructor.getModelMeta(Storeable.IGNORED_FIELDS_OBJECT_KEY + "_" + key);
        Object.assign(this, metaObject, value);
        return this;
    }
}
Storeable.IGNORED_FIELDS_OBJECT_KEY = "IGNORED_FIELDS_OBJECT";
